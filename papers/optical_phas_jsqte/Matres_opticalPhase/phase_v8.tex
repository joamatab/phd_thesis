...
% Phase changes due to vibrations are also compensated with the counter-propagating reference beam but we recommend to keep both arms of the interferometer still during the wavelength sweep.
...
% To reduce coupling loss and Fabry Perot reflections we tapered the corrugated waveguide at both ends, because, as we can see in Fig.~\ref{fig:corr}, amplitude variations in the transmission translate into phase fluctuations. 
...
% The results agree in trend, but the curve obtained with the heterodyne technique is more immune to the noise, and has the advantage of being continuous rather than scattered.
% Moreover, the fringe-spacing method is based on amplitude measurements and in some cases the position of the fringes is not very clear as the Fabry-Perot fringes superimpose with the fringes of the MZI (Fig.~\ref{fig:groupIndex}a).

...
\begin{figure}[htb]
  \centerline{\includegraphics[width=9cm]{corrAmpPhaseResponse}}
...
where $n_{g,ref}$ is the group index of the reference branch, obtained from the free spectral range (FSR) of the ring resonators (Eq.~\ref{eq:FSRanillo}).  % $n_{g,ref}=4.36$

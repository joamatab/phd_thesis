...
\begin{figure}[htb]
    \centering
    \includegraphics[width=1.0\textwidth]{timeResolved11}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=1.0\textwidth]{switching3}
...
\begin{figure}[htb]
    \centering
    \includegraphics[width=0.6\textwidth]{ntc02phase_exp_fit}
